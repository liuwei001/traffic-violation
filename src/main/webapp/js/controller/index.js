         	...
         	syncData("validatemsg/check/" + $("#code").val(),"GET",null,function(success,data){
             	if(success == true){
             		var param = [];
                		...
                		var supplier = "supplier," + $("#citySuppliers").val();
	        	...
	        	if(data != null) {
	            	...
	            	function choose() {
	                    ...
	                    if ($(this).hasClass('active')) {
	                        ...
	                        arr_supplier.splice($.inArray(supplier, arr_supplier), 1);
	                    } else {
	                        if (arr.length < 3) {
	                            ...
	                            arr_code.push(code);
	                            arr_abbr.push(abbr);
	                            arr_supplier.push(supplier);
	                        }
	                    }

	                    values = arr.join(', ');
						codes = arr_code.join('、');
						suppliers = arr_supplier.join(",")
	                    input.val(values);
						$("#cityText").val(codes);
						$("#citySuppliers").val(suppliers);
